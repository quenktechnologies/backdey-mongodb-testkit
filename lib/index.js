...
class Testkit {
    constructor(__config = {}) {
         ...
         */
        this.find = (collection, qry) => noniCollection.find(this.db.collection(collection), qry);
        /**
         * findOne document in a collection that matches the provided query object.
         */
        this.findOne = (collection, qry) => noniCollection.findOne(this.db.collection(collection), qry);
        /**
