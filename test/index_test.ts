...
describe('Testkit', () => {
    ...
    describe('populate', () => {
        ...
        it('should populate data', () => toPromise(doFuture(function*() {
            ...
            let results =
                yield noniCollection.find(kit.db.collection('datums'), {});
    ...
    describe('removeCollection', () => {
        ...
        it('should remove collections', () => toPromise(doFuture(function*() {
    ...
    describe('findOne', () => {
        ...
        it('should find a document', () => toPromise(doFuture(function*() {
            ...
            let mresult =
                yield kit.findOne('datums', { name: 2 });
    ...
    describe('update', () => {
        ...
        it('should update documents', () => toPromise(doFuture(function*() {
            ...
            let r =
                yield kit.update('datums', { name: 1 }, { $set: { name: 2 } });

            yield attempt(() => assert(r.modifiedCount).equal(2));

            let results =
                yield kit.find('datums', {});
